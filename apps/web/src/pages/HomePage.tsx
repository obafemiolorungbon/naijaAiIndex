...
const HomePage = () => {
  ...
  const latestUpdatedDate = useMemo(
    () =>
      projects.reduce<Date | null>((mostRecent, project) => {
  ...
  const latestUpdatedLabel = useMemo(() => {
    ...
    return latestUpdatedDate.toLocaleDateString("en-US", {
      month: "short",
      day: "numeric",
      year: "numeric",
    });
  ...
  const homeStructuredData = useMemo(
    () => [
      ...
      },
      {
        "@context": "https://schema.org",
        "@type": "CollectionPage",
        name: "Nigerian AI Projects Directory",
        description: HOME_META_DESCRIPTION,
        url: getAbsoluteUrl("/"),
        dateModified: latestUpdatedDate
          ? latestUpdatedDate.toISOString()
          : undefined,
        mainEntity: {
          "@type": "ItemList",
  ...
  return (
    <>
      <Seo
        title="Nigerian AI Projects Directory"
        description={HOME_META_DESCRIPTION}
        path="/"
      ...
      <div className={styles.page}>
        ...
        <section className={styles.trustGrid}>
          <article className={styles.trustCard}>
            ...
            <p>
              Entries are contributed by builders and reviewed through public
              pull requests.
            </p>
          </article>
          <article className={styles.trustCard}>
